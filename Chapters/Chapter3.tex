...
One can examine the values for the first excited states $2^+$ that are shown in Figs. . Indeed, these values show some peaks, each peak corresponding to a particular magic number.