...
The results for the $E2$ branching ratios, $M1/E2$ branching ratios, and the mixing ratios $\delta$ for $^{135}$Pr are compared with the experimental data in Table. \ref{new-boson-transitions-results}.
\begin{table}[]
    \centering
    \resizebox{\textwidth}{!}{%
