...
With these criteria in check, the fitting procedure was performed, and results gave an RMS of about $0.170\ \text{MeV}$. The obtained results are slightly larger but not by much with other work such as Ref. \cite{chen2016wobbling} ($\approx0.160\ \text{MeV}$) and Ref. \cite{budaca2018tilted} ($\approx0.150\ \text{MeV}$). This concludes the fact that a semi-classical analysis of the boson description for odd-mass wobbling nuclei is quite realistic. The excitation energies for all three bands are shown as level schemes in Figs. \ref{135pr-new-boson-band1} - \ref{135pr-new-boson-band23}, comparing the theoretical values with the experimental data.
\begin{figure}
    \centering
