...
\end{align}
where $E'$ is the energy after the $x_k$-free terms in Eq. \ref{constant-of-motion-E} have been subtracted from $E$. From the shape of Eq. \ref{energy-surface-E} it becomes clear why it is called energy surface, i.e., it resembles a general ellipsoid:
\begin{align}
    \frac{x_1^2}{a^2}+\frac{x_2^2}{b^2}+\frac{x_3^2}{c^2}=1\ ,
\end{align}
where $a,b,c$ are the semi-axes of different length, which for the energy surface $E'$ become:
\begin{align}
    a\to\sqrt{E's_1}\nonumber\ ,\\
    b\to\sqrt{E's_2}\nonumber\ ,\\
    c\to\sqrt{E's_3}\nonumber\ .
