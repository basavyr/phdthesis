...
Recalling all three situations, there are three stationary points that are of interest for the classical description of $H'$. All the situations are considered for a maximal MOI along the $2$-axis, meaning that this is the quantization axis. The points are provided in Table \ref{stationary-points-2-axis}.
\begin{table}[]
    \centering
    \resizebox{\textwidth}{!}{%
