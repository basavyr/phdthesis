...
Since the re-normalization of the band TSD4 is based on the idea that this band is the parity partner of TSD2, it is worth discussing the parity quantum number within this present semi-classical picture. Namely, one has to check if the trial function employed in the VP (Eq. \ref{tdve-approach-w1})
