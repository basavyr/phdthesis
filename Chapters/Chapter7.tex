...
With these criteria in check, the fitting procedure was performed, and results gave an RMS of about $0.170\ \text{MeV}$. The obtained results are slightly larger but not by much with other work such as Ref. \cite{chen2016wobbling} ($\approx0.160\ \text{MeV}$) and Ref. \cite{budaca2018tilted} ($\approx0.150\ \text{MeV}$).
\begin{table}
    \centering
