...
In the previous section, the study of wobbling motion in $^{163}$Lu in terms of the classical energy function has been performed. However, the analysis was only elaborated in the two-dimensional space generated by the set of polar coordinates (Eq. \ref{polar-coordinates-total-AM}), restricting somehow the geometrical interpretation of the system dynamics. In two recent publications \cite{poenaru2021extensive1,poenaru2021extensive2}, the team successfully gave a $3$-dimensional representation of the classical energy function.