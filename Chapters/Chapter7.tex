...
The free parameters attained after the minimization procedure of the $\chi^2$-function are given in Table \ref{lu163-parameters-parity-fitting}. However, the fitting method only gives the numerical values, without providing context on the physical interpretation of the obtained results. In this section one aims at making a quantitative analysis for the five quantities, and see how the current model compares with previous studies.