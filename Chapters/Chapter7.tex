...
Regarding the wobbling energy given as relative differences between the first excited band and yrast one, the results are shown in Fig. \ref{163Lu-wobbling-energy-parity-partners}. Here the first excited band is in fact TSD3, while yrast partner is TSD2. From the behavior of $E_\text{wob}$ it can be seen that the calculated values show an increasing trend with angular momentum, suggesting that $^{163}$Lu behaves as a longitudinal wobbler. 
\begin{figure}
    \centering
