...
Each factor from this equation will generate a curve within the $(u,v)$ plane (called a \emph{separatrix}). These separatrixes are bordering manifolds that define unique nuclear phases. This phase diagram is sketched in Fig. \ref{separatrix-diagram}.
\begin{figure}
    \centering
    \includegraphics[scale=0.65]{Chapters/Figures/new-boson-separatrix-diagram.pdf}
    \caption{Separatrix.}
