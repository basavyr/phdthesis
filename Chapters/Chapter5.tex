...
\begin{center}
    ...
    \begin{tikzpicture}
        \begin{axis}[every axis plot post/.append style={
            ...
            \node[rectangle, draw=blue, thick, fill=blue!20] at (axis cs: 1,0.9) {Density distributions for $\mathcal{Q}_p$ and $\mathscr{C}$};
        \end{axis}
        \node[rectangle, draw=blue, thick, fill=green!10] at (3,-3) (first-box) {Minimized short-range interaction};
        \node[rectangle, draw=blue, thick, fill=red!10] (second-box) [below=of first-box] {Minimal energy (PES)};
        \node[rectangle, draw=blue, thick, fill=blue!10] (second-box) [below=of second-box] {Stable triaxial shape};
    \end{tikzpicture}
