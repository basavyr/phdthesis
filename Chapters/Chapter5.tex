...
Getting back to the problem at hand, the two wobbling bands (denoted hereafter with $B1$ and $B2$) have also the transition between states measured experimentally (see experimental data in Ref. \cite{petrache2019diversity}).