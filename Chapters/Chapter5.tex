...
\begin{figure}
    \centering
    \includegraphics[scale=0.9]{Chapters/Figures/wobblers-chart-legend.pdf}
    \caption{Description of one element within the entire wobbling chart that is shown in Fig. \ref{wobblers-diagram-chart}}
