...
\begin{table}
    ...
    11                   & \multicolumn{1}{c|}{}                      & 0.379505           \\ \hline
    13                   & \multicolumn{1}{c|}{0.32}                  & 0.32112            \\ \hline
    15                   & \multicolumn{1}{c|}{0.36}                  & 0.278304           \\ \hline
    17                   & \multicolumn{1}{c|}{0.22}                  & 0.245562           \\ \hline
    19                   & \multicolumn{1}{c|}{0.22}                  & 0.219714           \\ \hline
    21                   & \multicolumn{1}{c|}{0.41}                  & 0.198788           \\ \hline
    23                   & \multicolumn{1}{c|}{}                      & 0.181502           \\ \hline
    25                   & \multicolumn{1}{c|}{}                      & 0.166982           \\ \hline
    \end{tabular}%
    \caption{The ratios $\frac{B(E2)_\text{out}}{B(E2)_\text{in}}$ for $^{130}$Ba. The experimental data (where available) was taken from Ref. \cite{petrache2019diversity,chen2019transverse}.}
