...
\begin{center}
    \begin{figure}
        ...
        \begin{tikzpicture}[every text node part/.style={align=center}]
            ...
            \node[rectangle, draw=black, thick, fill=red!10, inner sep=0.2cm] (second-box) [below=of first-box] {\textbf{Minimal} energy (PES) \\ \includegraphics[scale=0.1]{Chapters/Figures/PES_small_update.png}};
            ...
            % \draw[-latex] [very thick,black] (inside-node.east) -- ($(inside-node.east)+(2,0)$) |- (first-box.east);
            \draw[-latex] [very thick,black] (inside-node.east) -- ($(inside-node.east)+(2.2,0)$) |- node [xshift=-1.9cm,yshift=2.7cm] {\textbf{Maximal overlap} \\ between \\ $\mathcal{D}\left(\mathcal{Q}_p\right)$ and $\mathcal{D}\left(\mathscr{C}\right)$} (first-box.east);
