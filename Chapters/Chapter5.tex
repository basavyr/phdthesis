...
\begin{center}
    ...
    \begin{tikzpicture}[every text node part/.style={align=center}]
        ...
        \node[rectangle, draw=black, thick, fill=green!10, inner sep=0.2cm] at (2,-2) (first-box) {\textbf{Minimized} short-range interaction \\ \\ $\mathcal{Q}_p+\mathscr{C}$ = \emph{attractive}};
        ...
        \draw[-latex] [very thick,black] (inside-node.east) -- ($(inside-node.east)+(2,0)$) |- node [xshift=1cm,yshift=2cm] {\textbf{Maximal overlap} \\ between $\mathcal{D}$ and $\mathcal{D}$} (first-box.east);
