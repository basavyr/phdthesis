...
\begin{figure}
    ...
    \caption{The experimental wobbling energy, defined through the Eq. \ref{eq-wobbling-energy-definition-oddA}, for nuclei within the $A\approx 130$ mass region. Data are taken from references cited in text for each isotope. For $^{135}$Pr, the transition from a TW regime to LW which was identified in \cite{sensharma2019two} is marked by the two colored regions. The experimental data shown for $^{138}$Nd consist in the absolute values of the energies among the yrast and excited bands.}
