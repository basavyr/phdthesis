...
Lastly, an inventory with all the known wobbling nuclei was made, for different mass regions. Deformation parameters, wobbling bands and wobbling character were pointed out in a unified diagram containing all the nuclei (Fig. \ref{wobbling-diagram-chart}) which is a first within literature.