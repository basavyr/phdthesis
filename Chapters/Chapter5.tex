...
\begin{center}
    \begin{figure}
        ...
        \begin{tikzpicture}[every text node part/.style={align=center}]
            ...
            % \draw[-latex] [very thick, color=magenta] (2,5.5) -- \node[color=blue] {particle} (4.5,6.5);
            ...
            \draw[-latex] [very thick,black] (inside-node.east) -- ($(inside-node.east)+(2.2,0)$) |- node [xshift=-1.9cm,yshift=2.7cm] {\textbf{Maximal overlap} \\ between \\ {\color{magenta}$\mathcal{D}\left(\mathcal{Q}_p\right)$} and {\color{black!60!green}$\mathcal{D}\left(\mathscr{C}\right)$}} (first-box.east);
