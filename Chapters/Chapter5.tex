...
% \begin{align}
%     \delta(E2/M1)=c\cdot E_\gamma\frac{\bra{I_f}|\mathcal{M}(E2)|\ket{I_i}}{\bra{I_f}|\mathcal{M}(M1)|\ket{I_i}, 
% \end{align}
where $E_\gamma=E(I_i)-E(I_f)$ and the usual reduced matrix elements corresponding to the electric quadrupole and magnetic dipole transitions, respectively.
