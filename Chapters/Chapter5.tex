...
An important remark should be made here regarding the used model. Even though the spectrum of this even-even nucleus has been quantitatively reproduced quite well, and the values for the tree obtained MOI indicate a triaxial nucleus with main rotation around the third axis, it should not be considered a `realistic' tool in describing this isotope. This is because in another calculation, Chen et al. \cite{chen2019transverse} found through microscopic theory that the wobbling motion does not occur as per a pure triaxial rotator, but it comes from the coupling of two quasi-particles $\pi(h_{11/2})^2$ with a triaxial core. In fact, their inedited work shows that $^{130}$Ba is the first nucleus in which a configuration with two quasi-particles generate wobbling motion.