...
\end{align}
Manipulating the obtained terms from Eq. \ref{B-C-prime-terms}, one concludes that they are in fact equivalent with the factors $B$ and $C$ that were given in Eqs. \ref{omega-B-term} - \ref{omega-C-term}.