...
\begin{align}
    \ket{\Psi_{IM;j}}=\frac{1}{\sqrt{2j+1}}\sum_{M_R\Omega}C_{M_R\Omega M}^{RjI}C_{RM_R}\ket{RM_R}\ket{j\Omega}\ ,
\end{align}
where $M_R$ is the projection of the core's a.m. (in the lab system) onto the quantization axis.
