...
For calculation of the transition quadrupole moment $Q_I$ (Eq. \ref{quadrupole-transition-moment-QI}) and the SMQ (Eq. \ref{static-quadrupole-moment}), the results are compared with the experimental data in Table.
