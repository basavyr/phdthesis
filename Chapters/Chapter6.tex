...
\begin{table}
    ...
    \hline
    Band &        Spin sequence                  & $\mathcal{Q}$             & $\mathscr{C}$                      & Parity      & Signature      \\ \hline
    TSD1 &        $13/2,\ 17/2 \dots 97/2$       &       $\pi_{13/2}$        &      $0,2,4,\dots$                 &    $\pi=+$  & $\alpha=+1/2$  \\ \hline
    TSD2 &        $27/2,\ 31/2 \dots 91/2$       &       $\pi_{13/2}$        &      $TSD1+1\Gamma^\dagger$         &    $\pi=+$  & $\alpha=-1/2$  \\ \hline
    TSD3 &        $33/2,\ 37/2 \dots 85/2$       &       $\pi_{13/2}$        &      $TSD1+2\Gamma^\dagger$         &    $\pi=+$  & $\alpha=+1/2$  \\ \hline
    TSD4 &        $47/2,\ 51/2 \dots 83/2$       &       $\pi_{9/2}$         &      $TSD1+3\Gamma^\dagger$         &    $\pi=-$  & $\alpha=-1/2$  \\ \hline
    \end{tabular}%
    }
    \caption{The data concerning spins and parity assignments for $^{163}$Lu as per $\mathbf{W_0}$. Note that the quasi-particle $\mathcal{Q}$ is different for TSD4, and the core's angular momentum is only defined for TSD1, since the excited bands are created through $\Gamma^\dagger$.}
