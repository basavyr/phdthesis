...
\begin{itemize}
    \item $^{161}$Lu
    \begin{itemize}
        \item There are only two bands, emerging from the coupling of $\mathcal{Q}_1$ with the even-even core
