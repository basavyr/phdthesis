...
\end{align}
where $\mathcal{H}$ is just the average of $\hat{H}$ on the trial function, just as defined in Eq. \ref{hamiltonian-average}. It now plays the role of \emph{classical energy function} and moreover, it is a constant of motion, implying that the energy of the system must be somehow conserved.