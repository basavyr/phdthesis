...
\begin{table}
    ...
    \hline
    \multicolumn{2}{|c|}{} & \multicolumn{2}{c|}{\begin{tabular}[c]{@{}c@{}}$B(M1)$\\ $[\mathrm{e}^2\cdot\text{fm}^2]$\end{tabular}} & \multicolumn{2}{c|}{\begin{tabular}[c]{@{}c@{}}$\delta(E2/M1)$\\ $[\text{MeV}\cdot\text{fm}]$\end{tabular}} & \multicolumn{2}{c|}{} & \multicolumn{2}{c|}{\begin{tabular}[c]{@{}c@{}}$B(M1)$\\ $[\mathrm{e}^2\cdot\text{fm}^2]$\end{tabular}} & \multicolumn{2}{c|}{\begin{tabular}[c]{@{}c@{}}$\delta(E2/M1)$\\ $[\text{MeV}\cdot\text{fm}]$\end{tabular}} \\ \hline
    \multicolumn{1}{|c|}{} & \multicolumn{1}{c|}{$I$} & \multicolumn{1}{c|}{Th} & \multicolumn{1}{c|}{Exp} & \multicolumn{1}{c|}{Th} & Exp & \multicolumn{1}{c|}{} & $I$ & \multicolumn{1}{c|}{} & Exp & \multicolumn{1}{c|}{Th} & Exp \\ \hline
