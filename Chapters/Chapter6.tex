...
\begin{figure}
    ...
    \caption{The evolution of $\mathcal{A}_\varphi$ with respect to the generalized coordinate $\varphi$, at different MOI orderings. The magnitude of $A_{1,2,3}$ is arbitrary.}
