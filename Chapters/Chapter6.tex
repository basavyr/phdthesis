...
\end{align}
where the transition operator was separated into a collective term and a single-particle term. The two quadrupole moments $Q_{0,2}$ represent a measure of deformation and asymmetry in the shape of the nucleus. They are functions of deformation parameters, i.e. \cite{raduta2018wobbling}:
\begin{align}
    Q_0=\frac{3}{4\pi}ZR^2\beta\cos\gamma\ ,\ Q_2=\frac{3}{4\pi}ZR^2\frac{\sin\gamma}{\sqrt{2}}\ .
\end{align}