...
In addition to the quadrupole moment for transitions $I \to I-2$, the \emph{static quadrupole moment} can also be studied \cite{bohr1998nuclear}. This quantity gives a measure of nuclear charge distribution associated with the collective rotational motion of the nucleus \cite{chen2020g,chen2020static}, and it is in fact given by the diagonal m.e. of $\mathcal{M}(E2)$ (that is $I_i=I_f$, unlike $Q_I$, where $I_f=I_i-2$).
\begin{align}
    Q_\text{static}=C_{K2K}^{I2I}C_{I0I}^{I2I}Q_I
