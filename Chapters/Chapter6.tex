...
The transition probabilities between states that comprise the excitation spectra of the studied nuclei can be determined from the matrix elements of the \emph{quadrupole transition operators}. As it was discussed in Chapter \ref{chapter-3}, knowing the structure of the operator initial and final wave-functions
