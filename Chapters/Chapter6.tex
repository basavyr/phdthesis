...
The wave-functions which need to be used in the calculus of transition probabilities can be developed from the the following exploit: expansion up to first-order (abbreviated `1st or.') in the coordinates $(r,\varphi;f,\psi)$ and then perform re-quantization of the coordinates as per the mentioned recipe. Thus, from the wave-function of Eq. \ref{wave-function-TSD1-p0} one obtains:
\begin{align}
