...
\begin{align}
    \mu_I=g_RI+(g_K-g_R)\frac{K^2}{I+1}\ ,
    \label{static-magnetic-moment}
\end{align}
where the difference $(g_K-g_R)$ is directly extracted from $B(M1;I\to I-1)$ transitions, while the projection $K$ remains unchanged from $I$ to $I-1$, and also $K>1/2$. It follows that the expression of $(g_K-g_R)$ is given by the following rule \cite{bohr1998nuclear}:
\begin{align}
    (g_K-g_R)=\sqrt{\frac{4\pi}{3}}\frac{1}{\mu_N}\left[\frac{B(M1;I\to I-1)}{K^2\ \left(C_{K\ 0\ K}^{I\ 1\ I-1}\right)^2}\right]^{1/2}\ .
\end{align}

By firstly evaluating $(g_K-g_R)$, one can then determine the static moments from Eq. \ref{static-magnetic-moment}. Some results concerning states from TSD2 in $^{163}$Lu are shown in comparison with the experimental estimates.