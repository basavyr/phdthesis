...
The transformations that go from $(\hat{q}_1,\hat{q}_2)$ and $(\hat{p}_1,\hat{p}_2)$ to $(a^\dagger, a)$ and $(b^\dagger, b)$ are \emph{canonical}. The two constant factors $k_1$ and $k_2$ that appear in Eqs. \ref {creation-operators-a} - \ref{canonical-transformations-ab-qp} are called \emph{canonicity factors} (firstly introduced by the team in \cite{raduta2017semiclassical}), and their expressions are \cite{raduta2020approach}:
\begin{align}
    1
\end{align}