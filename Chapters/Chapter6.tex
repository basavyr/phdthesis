...
\begin{multline}
    \mathcal{H}=\bra{\Psi_{IjM}}\hat{H}\ket{\psi_{IjM}}=\\
    =\frac{I}{2}(A_1+A_2)+A_3I^2+\frac{j}{2}(A_1+A_2)+A_3j^2-2A_3Ij+\\
    +\frac{2I-1}{2I}r(2I-r)(A_1\cos^2\varphi+A_2\sin^2\varphi-A_3)+\\
    +\frac{2j-1}{2j}f(2j-f)(A_1\cos^2\psi+A_2\sin^2\psi-A_3)
\end{multline}