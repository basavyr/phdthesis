...
\begin{table}
    ...
    TSD3  & $1$       & $0$       & $\mathcal{F}_{10}^{I-1}=\frac{1}{2}\left(3\cdot\Omega_1^{I-1}+\Omega_2^{I-1}\right)$ & $33/2^+$ & $85/2^+$ & $j_1^\pi=13/2^+\stackrel{not}{\equiv}\mathcal{Q}_1$ \\ \hline
...
\end{align}
where $\epsilon_{13/2}$ and $\epsilon_{9/2}$ are the single-particle shell energies for $\mathcal{Q}_1$ and $\mathcal{Q}_2$, respectively.