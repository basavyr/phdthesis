...
\begin{figure}
    ...
    \caption{The evolution of $\mathcal{A}_\varphi$ with respect to the generalized coordinate $\varphi$, at different MOI orderings. Regarding the inertial factors, they keep the same magnitudes, but only their ordering change. The following calculations involve the arbitrary values $1, 3, 7$ (in units of $\hbar^{-2}MeV)$.}
