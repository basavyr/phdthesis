...
\end{align}
for TSD3. The two protons (quasi-particles of particle character $\mathcal{Q}_p$) are denoted with $\mathcal{Q}_1$ and $\mathcal{Q}_2$ and their angular momenta will be labelled $j_1=13/2$ for $\mathcal{Q}_1$ and $j_2=9/2$ for $\mathcal{Q}_2$. The `p' abbreviation from the quasi-particle notation (as per the rules in Table \ref{notation-table-wobbling}) will be dismissed from now on because all the discussed isotopes have odd quasi-particles of \emph{particle} character.

With the Eqs. \ref{renormalized-bands-structure-TSD124} - \ref{renormalized-bands-structure-TSD3} as `recipes', one can obtain the wobbling energies for this isotope as per Eq. \ref{tsd-bands-general-spectrum} by adopting the proper spin values $I$ and the wobbling phonon numbers $n_{w_1}$ and $n_{w_2}$. These values are given in Table \ref{lu-163-phonon-numbers}. Notice that for TSD1-2-4, because they were obtained as ground states, the pair of phonon numbers are $(0,0)$. Moreover, the TSD3 states are activated only by the phonon number $n_{w_1}$, which is consistent with the theory from $\mathbf{W_0}$ where the excited wobbling states were generated only by the phonon corresponding $\Omega_1$.
\begin{table}
    \centering
    \resizebox{\textwidth}{!}{%
    ...
    TSD1  & $0$       & $0$       & $\mathcal{F}_{00}^I=\frac{1}{2}\left(\Omega_1^I+\Omega_2^I\right)$          & $13/2^+$                                                       & $97/2^+$                                                        & $j_1^\pi=13/2^+$ \\ \hline
    TSD2  & $0$       & $0$       & $\mathcal{F}_{00}^I=\frac{1}{2}\left(\Omega_1^I+\Omega_2^I\right)$          & $27/2^+$                                                       & $91/2^+$                                                        & $j_1^\pi=13/2^+$ \\ \hline
    TSD3  & $1$       & $0$       & $\mathcal{F}_{00}^I=\frac{1}{2}\left(\Omega_1^I+\Omega_2^I\right)$          & $33/2^+$                                                       & $85/2^+$                                                        & $j_1^\pi=13/2^+$ \\ \hline
    TSD4  & $0$       & $0$       & $\mathcal{F}_{00}^I=\frac{1}{2}\left(\Omega_1^I+\Omega_2^I\right)$          & $47/2^-$                                                       & $83/2^-$                                                        & $j_2^\pi=9/2^-$  \\ \hline
    \end{tabular}%
    }
...
\begin{align}
    E_{I00}^\text{TSD1}=\epsilon_1+\mathcal{H}_\text{min}^I+F_{00}^I=\epsilon_1+\mathcal{H}_\text{min}^I+\frac{1}{2}\left(\Omega_1^I+\Omega_2^I\right)\ .
\end{align}