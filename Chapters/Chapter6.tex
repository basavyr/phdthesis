...
\begin{align}
    \ket{\Phi_{IMj}}=\ket{\Psi_{I-1M-1j}^{(1)}}\frac{1}{\sqrt{n_{w_1}!}}\left\{\left(\Gamma_1^\dagger\right)^{n_{w_1}}|\varnothing)_{I-1}\otimes\left(\Gamma_2^\dagger\right)^{n_{w_2}}|\varnothing)_j\right\}\ ,
