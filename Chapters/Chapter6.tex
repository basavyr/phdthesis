...
The quadrupole transition moment $Q_I$ can be also calculated for a state $I$ in terms of the reduced transition probability $B(E2; I\to I-2)$. The probability of the transition $I\to I-2$ is expressed in terms of the moment $Q_I$ as \cite{hagemann1984signature}:
\begin{align}
...
\end{align}
which will be adopted throughout the calculations. In addition to the quadrupole moment for transitions $I \to I-2$, the \emph{static quadrupole moment} can also be studied \cite{bohr1998nuclear,chen2020g,chen2020static}. This quantity gives a measure of nuclear charge distribution associated with the collective rotational motion of the nucleus, and it is calculated as:
\begin{align}
    Q_\text{st}^I=
\end{align}
