...
% \end{align}
% The operator which corresponds to the contribution of the odd proton, i.e.,  $T_{2\mu}^\text{sp}$ given in Eq. \ref{quadrupole-transition-operator-terms} has the following form:
% \begin{align}
