...
\begin{align}
    Q_\text{SQM}=C_{K2K}^{I2I}C_{I0I}^{I2I}Q_I\ .
    \label{static-quadrupole-moment}
\end{align}

Indeed, by  Looking at Eq. \ref{static-quadrupole-moment}, the SQM is nothing else than the measured quadrupole moment for a given state $I$, which was previously discussed in Section \ref{intro-EM-chapter3} and its the general expression was provided in Eq. \ref{quadrupole-moment-spectro}.
...
\begin{table}
    ...
    \hline
    \multicolumn{2}{|c|}{} & \multicolumn{2}{c|}{\begin{tabular}[c]{@{}c@{}}$Q_I$\\ $[b]$\end{tabular}} & \multicolumn{2}{c|}{} & \multicolumn{2}{c|}{\begin{tabular}[c]{@{}c@{}}$Q_\text{SQM}$\\ $[b]$\end{tabular}} \\ \hline
    \multicolumn{1}{|c|}{TSD1} & $I$ & \multicolumn{1}{c|}{Theory} & Experiment & \multicolumn{1}{c|}{TSD2} & \multicolumn{1}{c|}{$I$} & \multicolumn{1}{c|}{Theory} & Experiment \\ \hline
    \multicolumn{1}{|c|}{\multirow{8}{*}{$^{161}$Lu}} &  & \multicolumn{1}{c|}{8.89} & - & \multicolumn{1}{c|}{\multirow{8}{*}{$^{161}$Lu}} & \multicolumn{1}{c|}{} & \multicolumn{1}{c|}{8.92} & - \\ \cline{2-4} \cline{6-8} 
    \multicolumn{1}{|c|}{} &  & \multicolumn{1}{c|}{8.91} & - & \multicolumn{1}{c|}{} & \multicolumn{1}{c|}{} & \multicolumn{1}{c|}{8.93} & - \\ \cline{2-4} \cline{6-8} 
    \multicolumn{1}{|c|}{} &  & \multicolumn{1}{c|}{8.92} & - & \multicolumn{1}{c|}{} & \multicolumn{1}{c|}{} & \multicolumn{1}{c|}{8.95} & - \\ \cline{2-4} \cline{6-8} 
    \multicolumn{1}{|c|}{} &  & \multicolumn{1}{c|}{8.94} & - & \multicolumn{1}{c|}{} & \multicolumn{1}{c|}{} & \multicolumn{1}{c|}{8.96} & - \\ \cline{2-4} \cline{6-8} 
    \multicolumn{1}{|c|}{} &  & \multicolumn{1}{c|}{8.95} & - & \multicolumn{1}{c|}{} & \multicolumn{1}{c|}{} & \multicolumn{1}{c|}{8.97} & - \\ \cline{2-4} \cline{6-8} 
    \multicolumn{1}{|c|}{} &  & \multicolumn{1}{c|}{8.96} & - & \multicolumn{1}{c|}{} & \multicolumn{1}{c|}{} & \multicolumn{1}{c|}{8.98} & - \\ \cline{2-4} \cline{6-8} 
    \multicolumn{1}{|c|}{} &  & \multicolumn{1}{c|}{8.97} & - & \multicolumn{1}{c|}{} & \multicolumn{1}{c|}{} & \multicolumn{1}{c|}{8.98} & - \\ \cline{2-4} \cline{6-8} 
    \multicolumn{1}{|c|}{} &  & \multicolumn{1}{c|}{8.98} & - & \multicolumn{1}{c|}{} & \multicolumn{3}{c|}{} \\ \hline
    \end{tabular}
