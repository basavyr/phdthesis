...
For calculation of the transition quadrupole moment $Q_I$ (Eq. \ref{quadrupole-transition-moment-QI}) and the SMQ (Eq. \ref{static-quadrupole-moment}), the results are compared with the experimental data in Table \ref{quadrupole-QI-QSQM-numerical-results}. The interband transitions $I\to I-1$ were evaluated for the isotopes and the comparison between the theoretical results and the experimental data is provided in Table \ref{interband-E2-numerical-results}.
\begin{table}
    \centering
    \resizebox{\textwidth}{!}{%
