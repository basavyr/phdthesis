...
Regarding the wave-functions utilized for the numerical calculations in the $\mathbf{W_1}$ picture, these can be created from the expansion up to first-order (abbreviated `1st or.') in the coordinates $(r,\varphi;f,\psi)$ and then perform re-quantization of the coordinates. Thus, from the wave-function of Eq. \ref{wave-function-TSD1-p0} one obtains:
\begin{align}
