...
\end{align}
where $M_R$ is the projection of the core's a.m. (in the lab system) onto the quantization axis. The quantum number $K$ still signifies the projection of $\mathbf{I}$ onto the quantization axis (but in the intrinsic system). The term $C_{RK}$ is in accordance to Ref. \cite{raduta2018wobbling}:
\begin{align}
