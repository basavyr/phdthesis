...
\subsection{Dispersion Equation - Wobbling Frequencies}
...
\end{align}
where the coefficients $B$ and $C$ are expressed below. 

In a work done by Raduta et al \cite{raduta2017semiclassical}, a similar equation was obtained via a Random Phase Approximation (RPA) method applied to another (quantized) energy function.