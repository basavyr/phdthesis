...
\end{align}
where $N_T$ represents the total number of states of the isotope. For example, in the case of $^{163}$Lu, the $\chi^2$-function will contain all states belonging to TSD1-2-3 and TSD4. As an observation, the band-head energy $E_{13/2,0,0}^\text{TSD1}$ will be excluded, since its corresponding excitation energy is null. 