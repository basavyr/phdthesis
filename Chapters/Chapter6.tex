...
\begin{align}
    \mathcal{H}=&\mathcal{H}_\text{min}+\nonumber\\
                ...
                &-2A_3r'f'-2IjA_2\varphi'\psi'\ .
\end{align}
where the primed coordinates $r',\varphi',f',\psi'$ are the deviations from the minimum point $p_0$.