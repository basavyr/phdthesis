...
\begin{align}
    T_{2\mu}^\text{coll}=\sum_{\nu=-2,0,2}\mathcal{D}_{\mu\nu}^2Q_{\nu}=\mathcal{D}_{\mu 0}^2Q_{0}+\left(\mathcal{D}_{\mu 2}^2+\mathcal{D}_{\mu -2}^2\right)Q_{2}\ ,
...
\begin{align}
    Q_{0}=\frac{3}{4\pi}ZR^2\beta\cos\gamma\ ,\ Q_{2}=\frac{3}{4\pi}ZR^2\sin\gamma/\sqrt{2}\ ,
...
\begin{align}
    \mathcal{M}(E2,\mu)=\left[\mathcal{D}_{\mu 0}^2Q_{20}+\left(\mathcal{D}_{\mu 2}^2+\mathcal{D}_{\mu -2}^2\right)Q_{22}\right]+z_\text{eff}\sum_{\nu=-2,0,2}^2 \mathcal{D}_{\mu\nu}^2 r^2Y_2^\nu\ .
\end{align} 
