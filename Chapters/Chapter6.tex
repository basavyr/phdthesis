...
\begin{align}
    ...
    \mathcal{A}_{\varphi\psi}=\ ,\nonumber\\
    \mathcal{A}_\gamma=\ ,
    \label{classical-energy-function-A-factors}
\end{align}
% \left[\cos\gamma-\frac{f(2j-f)}{2j^2}\sqrt{3}\left(\sqrt{3}\cos\gamma+\sin\gamma\cos 2\psi\right)\right]