...
\begin{align}
    \chi_\mathcal{Q}&=\sum_{j\Omega}c_{j\Omega}\ket{j\Omega}\nonumber\\
    \bar{\chi}_\mathcal{Q}&=\sum_{j\Omega}c_{j-\Omega}\ket{j-\Omega}\ ,
    \label{j-Omega-single-particle-states}
\end{align}
where the wave-function is expressed in terms of the projections $\Omega=-j,\dots,j$. Obviously, the single-particle also has time-reversed states.