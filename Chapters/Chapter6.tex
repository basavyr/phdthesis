...
In the numerical calculations the set of formulas obtained in Eq. \ref{lu163-absolute-energies-tsd1234} will be all subtracted from the band-head energy, obtaining thus the excitation energies (recall Eq. \ref{excitation-energy-general-formula}) for $^{163}$Lu.
\begin{align}
