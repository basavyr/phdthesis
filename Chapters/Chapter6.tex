...
\begin{align}
    ...
    \label{phoninic-term-tsd-energies}
\end{align}
which is obtained from the procedure of linearization described above. Putting together Eq. \ref{tsd-bands-compressed-spectrum} and Eq. \ref{phoninic-term-tsd-energies}, the general spectrum of an odd-mass triaxial nucleus will be:
\begin{align}
