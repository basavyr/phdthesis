...
When $B$ must vanish, a second-degree algebraic equation for the variable $S$ will emerge:
\begin{align}
...
\end{align}
From Eqs. \ref{B-Term-zero-solutions} and \ref{C-Term-zero-solutions}, four solutions of the variable $S$ were obtained. These will be graphically represented in order to identify the regions where $Omega^4+B\Omega^2+C$ is vanishing.