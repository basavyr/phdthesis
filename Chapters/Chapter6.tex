...
\begin{align}
    \ket{\Psi_{IMj}}|_{p_0}\stackrel{\text{1st ord.}}{\equiv}&\ket{\Psi_{IMj}^{(1)}}=\frac{1}{2^{I+j}}\sum_{K\Omega}\binom{2I}{I-K}^{1/2}\binom{2j}{j-\Omega}^{1/2}\ket{IMK}\ket{j\Omega}\times\nonumber\\
...
\begin{align}
    \ket{\Psi_{IMj}}=\ket{\Psi_{I-1M-1j}^{(1)}}\frac{1}{\sqrt{n_{w_1}!}}\left\{\left(\Gamma_1^\dagger\right)^{n_{w_1}}|\varnothing)_{I-1}\otimes\left(\Gamma_2^\dagger\right)^{n_{w_2}}|\varnothing)_j\right\}\ ,
