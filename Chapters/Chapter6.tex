...
\begin{align}
    \mathcal{M}(E2,\mu)=&z_\text{eff}\left[Q_0\mathcal{D}_{\mu 0}^2-Q_2\left(\mathcal{D}_{\mu 2}^2+\mathcal{D}_{\mu -2}^2\right)\right]+z_\text{eff}\sum_{\nu=-2}^2\mathcal{D}_{\mu\nu}Y_2^\nu r^2\ ,\nonumber\\
