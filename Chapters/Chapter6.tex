...
\end{align}
Now it can be seen why such a transformation for $A_k$ is useful: the constant $1/\mathcal{I}_0$ can be factored out from $B$ and $C$, leaving only one `independent variable' $S=\mathcal{I}_0V$. Getting back to $C=0$ will yield the set:
