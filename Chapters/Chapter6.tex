...
When $B$ must vanish, a second-order algebraic equation for the variable $S$ will emerge:
\begin{align}
    P_{31}P{21}+8Ij\bar{A}_2\bar{A}_3+\left(Q_{31}+SG_1\right)\left(Q_{21}+SG_2\right)=0\ , \nonumber
\end{align}
or:
\begin{align}
