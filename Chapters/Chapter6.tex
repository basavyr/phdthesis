...
\end{align}
where the in-band (intraband) transitions are characterized for by a change $I\to I-2$ within the same band and out-band (interband) transitions are characterized by $I\to I-1$ but also $n_{w_1}\to n'_{w_1}$.
