...
\begin{figure}
    \centering
    \includegraphics[width=0.31\textwidth]{Chapters/Figures/BE2inout-1.pdf}
    \includegraphics[width=0.32\textwidth]{Chapters/Figures/BE2inout-2.pdf}
    \includegraphics[width=0.32\textwidth]{Chapters/Figures/BE2inout-3.pdf}
    \caption{The branching ratio for E2 transitions in $^{163}$Lu (\textbf{left}), $^{165}$Lu (\textbf{middle}), and $^{167}$Lu (\textbf{right}). The spin states belong to TSD2 for all isotopes. Experimental data are taken from Refs. \cite{hagemann2003wobbling,hamamoto2003nuclear,jensen2002evidence} ($A=163$), Ref. \cite{schonwasser2003one} ($A=165$), and Ref. \cite{amro2003wobbling} ($A=167$).}
...
\begin{figure}
    \centering
    \includegraphics[scale=0.65]{Chapters/Figures/BE2inout-4.pdf}
    \caption{The ratio $B(M1)/B(E2)_\text{in}$ for a few states connecting TSD2 and TSD1 from $^{163}$Lu. Experimental data are taken from Ref. \cite{reich2010nuclear}.}
