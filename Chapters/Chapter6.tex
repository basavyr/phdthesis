...
\begin{align}
    Q_I=\left[\frac{16\pi}{5}\cdot\frac{\bra{\Psi_{I}}|\mathcal{M}(E2)|\ket{\Psi_{I-2}}}{C_{K0K}^{I2I-2}}\right]^{1/2}\ ,
...
In addition to the quadrupole moment for in-band transitions $I \to I-2$, the \emph{static quadrupole moment} (SQM) can be studied \cite{bohr1998nuclear}. This quantity gives a measure of nuclear charge distribution associated with the collective rotational motion of the nucleus \cite{chen2020g,chen2020static}, and it arises as the diagonal m.e. of $\mathcal{M}(E2)$ (that is $I_i=I_f$, unlike $Q_I$, where $\Delta I_{i\to f}=2$). From Eqs. \ref{reduced-BE2-transitions-toki}, \ref{reduced-BE2-hagemann}, and Eq. \ref{quadrupole-transition-moment-QI} it results that the SQM can be expressed straight from the transition quadrupole moment via the relation \cite{bohr1998nuclear}:
\begin{align}
    Q_\text{SQM}(I)=C_{K2K}^{I2I}\ C_{I0I}^{I2I}\ Q_I\ .
    \label{static-quadrupole-moment}
\end{align}

Looking at Eq. \ref{static-quadrupole-moment} it can be seen that the SQM is nothing else than the measured quadrupole moment for a given state $I$, which was previously discussed in Section \ref{intro-EM-chapter3} and its the general expression was provided in Eq. \ref{quadrupole-moment-spectro}. Large magnitudes should also be expected for this quantity, as it is strictly related to the intraband quadrupole moments and implicitly on the $B(E2;I\to I-2)$ values.

In order to test the validity of the current interpretation, the reduced transition probabilities $B(E2)$ are calculated with the help of Eq. \ref{reduced-BE2-transitions-toki} and compared to the experimental data for each isotope. The numerical results are shown in Table \ref{intraband-E2-numerical-results} for the intraband transitions in TSD1 and TSD2. Unfortunately, experimental data could only be evaluated for $^{163}$Lu, meaning that for the other isotopes the quality of the model cannot by directly inferred. Nevertheless, from the similarities of the isotopes in regards to the other collective quantities that were assessed throughout the previous sections (e.g., dynamical MOI, reference energy, and so on) one expects a consistency across the electromagnetic transitions as well.
\begin{table}
    \centering
    \begin{tabular}{|c|c|c|c|c|ccc|}
    \hline
    \multicolumn{2}{|c|}{} & \multicolumn{2}{c|}{\begin{tabular}[c]{@{}c@{}}$B(E2;I\to I-2)$\\ $[\mathrm{e}^2b^2]$\end{tabular}} & \multicolumn{2}{c|}{} & \multicolumn{2}{c|}{\begin{tabular}[c]{@{}c@{}}$B(E2;I\to I-2)$\\ $[\mathrm{e}^2b^2]$\end{tabular}} \\ \hline
    ...
    \label{intraband-E2-numerical-results}
\end{table}

For calculation of the transition quadrupole moment $Q_I$ (Eq. \ref{quadrupole-transition-moment-QI}) and the SMQ (Eq. \ref{static-quadrupole-moment}), the results are compared with the experimental data in Table \ref{quadrupole-QI-QSQM-numerical-results}.
...
\begin{table}[]
    ...
    \multicolumn{1}{|c|}{\multirow{8}{*}{$^{161}$Lu}} & 41/2 & \multicolumn{1}{c|}{8.89} & - & \multicolumn{1}{c|}{} & - & \multicolumn{1}{c|}{\multirow{8}{*}{$^{161}$Lu}} & \multicolumn{1}{c|}{47/2} & \multicolumn{1}{c|}{} & \multicolumn{1}{c|}{-} & \multicolumn{1}{c|}{} & - \\ \cline{2-6} \cline{8-12} 
    \multicolumn{1}{|c|}{} & 45/2 & \multicolumn{1}{c|}{8.91} & - & \multicolumn{1}{c|}{} & - & \multicolumn{1}{c|}{} & \multicolumn{1}{c|}{51/2} & \multicolumn{1}{c|}{} & \multicolumn{1}{c|}{-} & \multicolumn{1}{c|}{} & - \\ \cline{2-6} \cline{8-12} 
    \multicolumn{1}{|c|}{} & 49/2 & \multicolumn{1}{c|}{8.92} & - & \multicolumn{1}{c|}{} & - & \multicolumn{1}{c|}{} & \multicolumn{1}{c|}{55/2} & \multicolumn{1}{c|}{} & \multicolumn{1}{c|}{-} & \multicolumn{1}{c|}{} & - \\ \cline{2-6} \cline{8-12} 
    \multicolumn{1}{|c|}{} & 53/2 & \multicolumn{1}{c|}{8.94} & - & \multicolumn{1}{c|}{} & - & \multicolumn{1}{c|}{} & \multicolumn{1}{c|}{59/2} & \multicolumn{1}{c|}{} & \multicolumn{1}{c|}{-} & \multicolumn{1}{c|}{} & - \\ \cline{2-6} \cline{8-12} 
    \multicolumn{1}{|c|}{} & 57/2 & \multicolumn{1}{c|}{8.95} & - & \multicolumn{1}{c|}{} & - & \multicolumn{1}{c|}{} & \multicolumn{1}{c|}{63/2} & \multicolumn{1}{c|}{} & \multicolumn{1}{c|}{-} & \multicolumn{1}{c|}{} & - \\ \cline{2-6} \cline{8-12} 
    \multicolumn{1}{|c|}{} & 61/2 & \multicolumn{1}{c|}{8.96} & - & \multicolumn{1}{c|}{} & - & \multicolumn{1}{c|}{} & \multicolumn{1}{c|}{67/2} & \multicolumn{1}{c|}{} & \multicolumn{1}{c|}{-} & \multicolumn{1}{c|}{} & - \\ \cline{2-6} \cline{8-12} 
    \multicolumn{1}{|c|}{} & 65/2 & \multicolumn{1}{c|}{8.97} & - & \multicolumn{1}{c|}{} & - & \multicolumn{1}{c|}{} & \multicolumn{1}{c|}{71/2} & \multicolumn{1}{c|}{} & \multicolumn{1}{c|}{-} & \multicolumn{1}{c|}{} & - \\ \cline{2-6} \cline{8-12} 
    \multicolumn{1}{|c|}{} & 69/2 & \multicolumn{1}{c|}{8.98} & - & \multicolumn{1}{c|}{} & - & \multicolumn{1}{c|}{} & \multicolumn{5}{c|}{} \\ \hline
    \end{tabular}%
    }
    \caption{The quadrupole transition moment $Q_I$ and the static quadrupole moment $Q_\text{SQM}$ are calculated for each isotope and compared with the available experimental data.}
    \label{quadrupole-QI-QSQM-numerical-results}
    \end{table}
