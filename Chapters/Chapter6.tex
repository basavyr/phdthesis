...
The matrix elements for the collective and single-particle components of $\mathcal{M}(E2)$ are given analytically in Appendix D from \cite{raduta2017semiclassical}.
