...
In Fig. \ref{fig-omega2-V-Gamma} a different approach is made for $\omega_2$. Indeed, since its dependence is given by $\gamma$ and also $V$, a contour plot within this representation is given, keeping the total spin fixed, as well as the single-particle a.m.
\begin{figure}
    \centering
    \includegraphics[scale=0.75]{Chapters/Figures/omega-2-gamma-V.pdf}
    \caption{The oscillator frequency $\omega_2$ within the $(\gamma,V)$ `plane'.}
