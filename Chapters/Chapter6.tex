...
\begin{figure}
    ...
    \caption{The static quadrupole moment from Eq. \ref{static-quadrupole-moment} graphically represented as a function of total spin $I$ for $^{163}$Lu. The data are evaluated by keeping $K$ fixed to $K=1/2$. See text for more details.}
