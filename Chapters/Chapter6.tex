...
Regarding the wave-functions utilized for the numerical calculations of $B(E2)$ and $B(M1)$ in the $\mathbf{W_1}$ picture, these can be constructed from the expansion of Eq. \ref{wave-function-TSD1-p0} up to first-order (abbreviated `1st or.') in the coordinates $(r,\varphi;f,\psi)$, and then perform re-quantization of the coordinates, which results in \cite{raduta2017semiclassical,raduta2020approach,raduta2020towards}:
\begin{align}
