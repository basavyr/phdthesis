...
In order to conclude this section, some graphical representations with the behavior of the oscillator frequencies $(\omega_1,\omega_2)$ and also the factors $k_1,k_2$ will be made, in order to get a qualitative interpretation of their behavior with respect to certain parameters.