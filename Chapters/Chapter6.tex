...
By quantizing the classical variables obtained from TDVE, it was possible to show an alternative description for the classical energy function of a triaxial nucleus, which can be summarized in the following way:
