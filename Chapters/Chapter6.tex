...
\begin{align}
    \{TSD1\}&\equiv\left\{\mathscr{C}_1\left[0^+,2^+,4^+,\dots\right]\right\}\otimes \left\{\mathcal{Q}_1[j_1=13/2^+]\right\}\ ,\ \nonumber\\
    \{TSD2\}&\equiv\left\{\mathscr{C}_2\left[1^+,3^+,5^+,\dots\right]\right\}\otimes \left\{\mathcal{Q}_1[j_1=13/2^+]\right\}\ ,\ \nonumber\\
    \{TSD4\}&\equiv\left\{\mathscr{C}_1\left[0^+,2^+,4^+,\dots\right]\right\}\otimes \left\{\mathcal{Q}_2[j_2=9/2^+]\right\}\ ,
...
With the Eqs. \ref{renormalized-bands-structure-TSD124} - \ref{renormalized-bands-structure-TSD3} as `recipes', one can obtain the wobbling energies for this isotope as per Eq. \ref{tsd-bands-general-spectrum} by adopting the proper spin values $I$ and the wobbling phonon numbers $n_{w_1}$ and $n_{w_2}$. These values are given in Table \ref{lu-163-phonon-numbers}. Notice that for TSD1-2-4, because they were obtained as ground states, the pair of phonon numbers are $(0,0)$. Moreover, the TSD3 states are activated only by the phonon number $n_{w_1}$, which is consistent with the theory from $\mathbf{W_0}$ where only the phonon corresponding to the wobbling frequency $\Omega_1$ is used.
\begin{table}
    \centering
    \resizebox{0.85\textwidth}{!}{%
    \begin{tabular}{|c|c|c|c|c|c|c|}
    \hline
    Bands & $n_{w_1}$ & $n_{w_2}$ & \begin{tabular}[c]{@{}c@{}}Phonon \\ term\end{tabular} & \begin{tabular}[c]{@{}c@{}}band-head state\\ $I_b$\end{tabular} & \begin{tabular}[c]{@{}c@{}}terminus state\\ $I_t$\end{tabular}  & $\mathcal{Q}$ \\ \hline
    TSD1  & $0$       & $0$       & $\mathcal{F}_{00}^I$ & $13/2^+$             & $97/2^+$    & $j_1^\pi=13/2^+$         \\ \hline
    TSD2  & $0$       & $0$       & $\mathcal{F}_{00}^I$ & $27/2^+$             & $91/2^+$    & $j_1^\pi=13/2^+$          \\ \hline
    TSD3  & $1$       & $0$       & $\mathcal{F}_{10}^I$ & $33/2^+$             & $85/2^+$    & $j_1^\pi=13/2^+$          \\ \hline
    TSD4  & $0$       & $0$       & $\mathcal{F}_{00}^I$ & $47/2^-$             & $83/2^-$    & $j_2^\pi=13/2^-$          \\ \hline
    \end{tabular}%
    }
