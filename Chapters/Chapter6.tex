...
\begin{figure}
    \centering
    \includegraphics[scale=0.5]{Chapters/Figures/Lu-exp-energies/fig7.pdf}
    \caption{The theoretical and experimental alignments for $^{161}$Lu, according to Eq. \ref{alignment-reference-angular-momentum}, as function of the rotational frequency (Eq. \ref{rotational-frequency-canonical}). The numerical evaluation was done with the Harris parameters defined in text.}
