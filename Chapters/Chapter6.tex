...
\begin{figure}
    ...
    \caption{The fitted MOI (see Table \ref{numerical-fitting-parameters-Lu-isotopes}) plotted as a function of the mass number $A$. The unfilled symbols represent the band TSD4 from $^{163}$Lu.}
