...
\begin{figure}
    ...
    \caption{The canonicity factor $k_2$ from Eq. \ref{canonicity-factors} in the ($\gamma,V)$ plane, evaluated at fixed inertia factors and angular momenta. The value $\gamma=25^\circ$ is marked by the vertical dashed line just to guide the eye.}
