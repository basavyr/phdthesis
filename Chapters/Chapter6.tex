...
\end{align}
which will be adopted throughout the calculations. In addition, the quadrupole moment associated to transitions $I \to I-2$, the \emph{static quadrupole moment} can also be studied \cite{chen2020g,chen2020static}. This quantity gives a measure of nuclear charge distribution associated with the collective rotational motion and it is calculated as:
