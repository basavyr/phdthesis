...
\begin{align}
    ...
    \left[\hat{H},b\right]=&-\omega_2-A_3k_1k_2\left(a^\dagger-a\right)+IjA_2\left(a^\dagger+a\right)\ .
...
\begin{align}
    \left[\hat{H},\Gamma^\dagger\right]=\Omega\Gamma^\dagger\ ,\ \left[\Gamma,\Gamma^\dagger\right]=i\ .
\end{align}