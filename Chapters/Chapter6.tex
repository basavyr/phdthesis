...
The states that are involved in $\Psi_\text{trial}$ are as follow: $\ket{IMK}$ represent the wave-functions of the total $\mathcal{Q}+\mathscr{C}$ system (i.e., eigenstates of $\hat{I}^2$ and $\hat{I}_3$), while $\ket{j\Omega}$ are the wave-functions of the odd quasi-particle $\mathcal{Q}$ (the eigenstates of $\hat{j}^2$ and $\hat{j}_-$).