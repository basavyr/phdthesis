...
In order to explain the theoretical implications of Figs. , one needs to understand that based on a MHO, a so-called \emph{Ultimate Cranker} numerical implementation has been developed \cite{bengtsson1989method,bengtsson1990high}. This implementation is able to give the values for $(\beta,\gamma)$ which a nucleus might achieve stability, practically identifying local and global minima within the potential energy surface.
