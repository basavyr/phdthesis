...
The graphical representation of the Lund convention is shown in Fig. \ref{lund-convention-graph}.
\begin{figure}
    \centering
...
\begin{table}[ht]
    ...
    \begin{tabular}{|c|c|c|c|}
        \hline 
        \multicolumn{4}{|c|}{\includegraphics[scale=0.65]{Chapters/Figures/tabular_ellipse.pdf}}\\ \hline 
        Shape    & \begin{tabular}[c]{@{}c@{}} n.o.\\ deformed axes\end{tabular} & Side view & Top view \\ \hline
        Prolate  & 1                                                              &   \includegraphics[scale=0.65]{Chapters/Figures/ellipse_prolate_1.pdf}        &      \includegraphics[scale=0.65]{Chapters/Figures/ellipse_prolate_2.pdf}      \\ \hline
        Oblate   & 1                                                              &      \includegraphics[scale=0.65]{Chapters/Figures/ellipse_oblate_1.pdf}      &     \includegraphics[scale=0.65]{Chapters/Figures/ellipse_oblate_2.pdf}       \\ \hline
        Triaxial & 2                                                              &      \includegraphics[scale=0.65]{Chapters/Figures/ellipse_triaxial_1.pdf}     &     \includegraphics[scale=0.65]{Chapters/Figures/ellipse_triaxial_2.pdf}      \\ \hline
        \end{tabular}
