...
\begin{figure}
    \centering
    \includegraphics[scale=0.55]{Chapters/Figures/nuclear-radius-elongation.pdf}
    \caption{A graphical representation with the increase in axis lengths along the $x$, $y$, and the $z$ directions, respectively.}
