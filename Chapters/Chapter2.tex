...
Regarding the dynamical character of $\hat{H}$ defined in Eq. \ref{eq-triaxial-prm-full-hamiltonian}, the coupling of the high-$j$ particle with a rotor will create special physical effects, which can be classified in the following way \cite{ring2004nuclear}:
\begin{itemize}
