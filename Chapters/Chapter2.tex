...
The so-called Lund convention \textbf{CITATION NEEDED} somewhat solves this redundancy, by selecting a rotational axis according to the set of rules described below:
...
\begin{figure}
    ...
    \caption{Representation of the nuclear shapes using the Lund convention. Figure is taken from \textbf{CITATION NEEDED}.}
