...
More insight with regards to the quadrupole shape of the nucleus can be achieved if one expresses $R$ in terms of cartesian coordinates (with the textbook procedure similar to the one in \cite{greiner1996nuclear}).

Starting from the expressions of the spherical harmonics in terms of the cartesian components of the unit vector $|\vec{u}|=1$ in a given direction $(\theta,\varphi)$:
\begin{align}
