...
\begin{table}[ht]
    ...
    \begin{tabular}{|c|c|c|c|}
        \hline
        Shape    & \begin{tabular}[c]{@{}c@{}}\# of \\ deformed axes\end{tabular} & Side view & Top view \\ \hline
        Prolate  & 1                                                              &   \includegraphics[scale=0.3]{Chapters/Figures/ellipse_prolate_1.pdf}        &      \includegraphics[scale=0.3]{Chapters/Figures/ellipse_prolate_2.pdf}      \\ \hline
        Oblate   & 1                                                              &      \includegraphics[scale=0.3]{Chapters/Figures/ellipse_oblate_1.pdf}      &     \includegraphics[scale=0.3]{Chapters/Figures/ellipse_oblate_2.pdf}       \\ \hline
        Triaxial & 2                                                              &      \includegraphics[scale=0.3]{Chapters/Figures/ellipse_triaxial_1.pdf}     &     \includegraphics[scale=0.3]{Chapters/Figures/ellipse_triaxial_2.pdf}      \\ \hline
