...
For the axially-symmetric quadrupole deformations, the parameter $\beta_2$ can be related to the axes of the spheroid via the formula:
% \begin{align}
%     \beta_2=\frac{4}{3}\sqrt{\frac{\pi}{5}}\frac{\Delta R}{}
% \end{align}
