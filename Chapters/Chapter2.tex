...
As an outline of this chapter, the shape and deformation of a nucleus will be detailed in Section \ref{nuclear-shapes}, while Section \ref{section-nuclear-models} will cover the specific models for deformed nuclei. Lastly, Section \ref{section-triaxial-signatures} will introduce the two unique characteristics to nuclei lacking any symmetry in regards to their equilibrium shape. A set of conclusions and key takeaways that emerge from all sections sections will be inferred at the end of the chapter.
