...
The graphical representation shown in Fig. \ref{table-ellipsoidal-shapes} aims as describing the possible nuclear shapes, depending on the number of deformation axes; namely, if there is only one deformation axis, then the nuclear shape is \emph{axial-symmetric} (oblate or prolate) and if there are two deformation axes, then the nucleus is triaxial (axially-asymmetric).
