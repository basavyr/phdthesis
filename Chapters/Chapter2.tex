...
\begin{figure}
    ...
    \caption{Beta-gamma plane divided into six regions. The part delimited from $\gamma=0^\circ$ to $\gamma=60^\circ$ can be considered as the representative one, while the others can be reproduced from this interval.}
