...
\begin{titlepage}
    \begin{center}
        ...
        \vspace{40mm}
        \textup{\LARGE{A Systematic Description of the Wobbling Motion in Odd-Mass Nuclei Within a Semi-Classical Formalism}}
    \end{center}
...
\title{A Systematic Description of the Wobbling Motion in Odd-Mass Nuclei Within a Semi-Classical Formalism}
