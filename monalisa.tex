...
Huge thanks and eternal appreciation to my \emph{medical team}, consisting of Dr. Demian, Dr. Mester, Dr. Radu, Dr. Zarma, without whom I could not be here in a good mental and physical state. Finishing my studies and, implicitly, this thesis was only possible through their careful attention. % Same amount of respect and gratitude are also expressed to Aurica for explaining to me and my family that time is always the crucial factor when it comes to health issues.
...
% chapters
\input{Chapters/Chapter1} % Chapter 1 // Introduction
\input{Chapters/Chapter2} % Chapter 2
% \input{Chapters/Chapter3} % Chapter 3 // The FRUP1 version
% \input{Chapters/Chapter4} % Chapter 4 // The FRUP2 version
\input{Chapters/Chapter5} % Chapter 5
\input{Chapters/Chapter6} % Chapter 6
\input{Chapters/Chapter7} % Chapter 7
\input{Chapters/Chapter8} % Chapter 8

% appendices 
\appendix
% shell model
\input{Chapters/Appendix_ShellModel.tex}
% bohr model
% \input{Chapters/Appendix_Bohr.tex}
% two-state mixing
\input{Chapters/Appendix_TwoState.tex}
% rotational bands
\input{Chapters/Appendix_RotationalBands.tex}
